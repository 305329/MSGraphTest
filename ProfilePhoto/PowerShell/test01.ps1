...
#######################GraphAPIで情報取得
$apiUrl = 'https://graph.microsoft.com/beta/users/304231@kao.com/photo/$value'
# $Data = Invoke-RestMethod -Headers @{Authorization = "Bearer $($Tokenresponse.access_token)"} -Uri $apiUrl -Method Get
$Data = Invoke-RestMethod -Headers @{Authorization = "Bearer $($Tokenresponse.access_token)"} -Uri $apiUrl -Method Get -ContentType image/jpeg -OutFile z:\test01\aaa.jpg
